...
def arb_batched_nms(bboxes, scores, inds, nms_cfg, x_reg=None, class_agnostic=False):
    ...
    #     x_reg = x_reg[keep]
    #     i=0
    #     path = '/cluster/home3/wjs/ARC_2/work_dirs/20240223/tsne/'+str(i)+'.pth'
    #     while(os.path.exists(path)):
    #         i = i+1
    #         path = '/cluster/home3/wjs/ARC_2/work_dirs/20240223/tsne/'+str(i)+'.pth'
    #     torch.save(x_reg, path)
        
    #     i=0
    #     path = '/cluster/home3/wjs/ARC_2/work_dirs/20240223/predbox/'+str(i)+'.pth'
    #     while(os.path.exists(path)):
    #         i = i+1
    #         path = '/cluster/home3/wjs/ARC_2/work_dirs/20240223/predbox/'+str(i)+'.pth'
    #     torch.save(bboxes, path)
